            ...
            <h1 style="color:#333">Các đơn hàng đã hoàn thành:</h1>
                ...
                <table>
                    <tr>
                        ...
                        <th style="min-width: 140px">Mã đơn hàng</th>
                        <th style="min-width: 130px">Ngày đặt hàng</th>
                        <th style="min-width: 150px;">Tên</th>
                        <th style="min-width: 120px;">Điện thoại</th>
                        <th style="min-width: 200px;">Địa chỉ</th>
                        <th style="min-width: 180px">Giao hàng</th>
                        <th style="min-width: 150px">Thanh toán</th>
                        <th style="min-width: 150px;">Chi tiết đơn hàng</th>   
