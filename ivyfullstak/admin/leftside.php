...
<section class="admin-content row space-between">
    <div class="admin-content-left">
        ...
        <!-- <ul>
                <li><a  href="index.php"> <img style="width:20px" src="icon/hi.png" alt="">Chào:  <span style="color:blueviolet; font-size:22px"><?php echo Session::get('admin_name') ?></span><span style="color: red; font-size:20px">&#10084;</span></a>
                ...
                <li>
                    <a href="#">
                        <img style="width:20px" src="icon/options.png" alt="">
                        Danh Mục
                    </a>
                    <ul>
        ...
        <ul>
            <li><a href="index.php"> <img style="width:20px" src="icon/hi.png" alt="">
                <span style="margin-right: 4px;">Chào:</span>
                <span style="color:blueviolet; font-size:22px"><?php echo Session::get('admin_name') ?></span><span
                        style="color: red; font-size:20px; margin-left: 3px">&#10084;</span></a>
            <li>
                <a href="#">
                    <div class="icon" style="width: 28px; margin-right: 3px">
            ...
            <li>
                <a href="#">
                    <div class="icon"><img src="icon/options.png" alt=""></div>
                    Danh Mục
                </a>
                <ul>
                    <li><a href="cartegorylist.php">Danh sách</a></li>
            ...
            <li>
                <a href="#">
                    <div class="icon"><img src="icon/menu.png" alt=""></div>
                    Loại Sản Phẩm
                </a>
                <ul>
                    <li><a href="brandlist.php">Danh sách</a></li>
            ...
            <li>
                <a href="#">
                    <div class="icon"><img src="icon/colour.png" alt=""></div> 
                    Màu sắc
                </a>
                <ul>
                    <li><a href="colorlist.php">Danh sách</a></li>
            ...
            <li>
                <a href="#">
                    <div class="icon"><img src="icon/article.png" alt=""></div>
                    Sản phẩm
                </a>
                <ul>
                    <li><a href="productlist.php">Danh sách</a></li>
            ...
            <li>
                <a href="#">
                    <div class="icon"><img src="icon/picture.png" alt=""></div>
                    Ảnh Sản phẩm
                </a>
                <ul>
                    <li><a href="anhsanphamlists.php">Danh sách</a></li>
            ...
            <li>
                <a href="#">
                    <div class="icon"><img src="icon/size.png" alt=""></div>
                    Size Sản phẩm
                </a>
                <ul>
                    <li><a href="sizesanphamlists.php">Danh sách</a></li>
            ...
            <li>
                <a href="?admin_id=<?php echo Session::get('admin_id') ?>"> 
                    <img src="icon/logout.png" alt="" class="icon" style="width: 29px; margin-right: 2px">
                    Đăng Xuất
                </a>
            </li>
        </ul>
